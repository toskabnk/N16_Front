    ...
    const handleDelete = async () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                try {
                    await eventTypeService.delete(token, location.state?.objectID.id);
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                const respone = isEdit ? await eventTypeService.update(token, location.state?.objectID.id, values) : await eventTypeService.create(token, values);
